...
user1 = User.create(username: "warrenniu", password: "pass123", first_name: "Warren", last_name: "Niu", birthday: "September 22 1988")

journal1 = Journal.create(year: 2020, month: "December", user: user1)
journal2 = Journal.create(year: 2021, month: "January", user: user1)
